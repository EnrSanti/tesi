...
Emphasys will be on describing the software extended, what are its new capabilities and how this task has been achieved.
...
A more concrete difference concering these two kind of ODEs is shown in Paragraph \ref{geometric}.
...............
...............
...............
...
A simple example of an ODE is represented by the Malthus equation:  \begin{center}$y'(t)=r*y(t)$ \end{center} \label{logisitcEQ} This equation\footnote{Where $r$ is a parameter.} is a linear autonomous first order ODE which can be solved analyitically by separation of variables.
...
On the other hand, it has not been a problem adapting to the programming language used by MatLab. 
