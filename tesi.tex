...
The first concept is to rewrite a delay differential equation as an abstract differential euqation. Without going into the details \cite{DDEdisc} the following system:
\begin{equation} 
\begin{cases}
\label{ddesystem}
